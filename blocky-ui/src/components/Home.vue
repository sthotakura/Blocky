  ...
  <div
    ...
    <div v-else>
      <div v-if="hasSecret">
        ...
        <secret-input-modal :is-open="isSecretInputModelOpen" :host="toUnblock" @secretInputModalCancelled="onSecretInputModelCancelled"/>
      </div>
      <div v-else>
...
export default defineComponent({
  ...
  setup() {
    ...
    const onUnblock = async (hostToUnblock: string) => {
